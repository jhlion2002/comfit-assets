...
/* =========================================================
   COMFIT HEADER CONTRAST
   본문 영역에 따라 Header 아이콘 색상 변경
========================================================= */
...
(function () {
  ...
  var searchIcon = header.querySelector(".search svg");
  var mobileMenu = header.querySelector(".mobile-menu");

  if (!searchIcon && !mobileMenu) return;
  ...
  function updateHeaderTone() {
    ...
    /*
     * Header 바로 아래의 본문 위치를 확인
     * header 자체가 fixed라서 elementsFromPoint를 사용
     */
    ...
    var tone = section.getAttribute("data-header-tone");
  ...
  window.addEventListener("scroll", updateHeaderTone, {
    passive: true
  });
